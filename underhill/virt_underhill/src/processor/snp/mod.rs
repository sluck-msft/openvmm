...
impl HvTranslateGvaSupport for UhProcessor<'_, SnpBacked> {
    ...
    fn guest_memory(&self, vtl: Vtl) -> &GuestMemory {
    ...
    fn registers(&mut self, vtl: Vtl) -> Result<TranslationRegisters, Self::Error> {
...
impl TranslateGvaSupport for UhProcessor<'_, SnpBacked> {
    ...
    fn acquire_tlb_lock(&mut self) {
        HvTranslateGvaSupport::acquire_tlb_lock(self, self.last_vtl());
    }

    fn registers(&mut self) -> Result<TranslationRegisters, Self::Error> {
        HvTranslateGvaSupport::registers(self, self.last_vtl())
    }
}
